<template>
  <div class="connectContainer">
    ...
    <div class="container flex h-auto flex-row connections items-center justify-center">
      <div data-cy="core_connect_wallet_button" class="tileContainer h-auto mr-5 md:mr-10 text-center" @click="customWallet()">
        <div class="tile">
      ...
      <div data-cy="core_connect_wallet_button" class="tileContainer h-auto ml-5 md:ml-10 text-center" @click="walletConnect()">
        <div class="tile">
