...
export const ETHER_NETWORK_LABEL_CAPITALIZED = ETHER_NETWORK_NAME.charAt(0).toUpperCase() + ETHER_NETWORK_NAME.slice(1).toLowerCase();
export const ETHER_NETWORK_LABEL_LOWERCASED = ETHER_NETWORK_NAME.toLowerCase();
