// import { WalletModuleState, state, mutations, getters } from "@/store/wallet";
//
// let walletState: WalletModuleState;
//
...
//  describe("initState", () => {
//    test("works", () => {
//      expect(walletState.loggedIn).toBe(false);
...
//
// import { APP_ZKSYNC_API_LINK, ETHER_NETWORK_NAME } from "@/types/lib";
...
// import { AccountModuleState } from "~/store/account";
//
